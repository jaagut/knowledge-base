...
[http://www.jdisc.com/en/downloads.html](http://www.jdisc.com/en/downloads/)
...
[http://www.jdisc.com/en/support.html](http://www.jdisc.com/en/support/)
...
The JDisc profiles of i-doit provide the possibility to define the connection of object types and their attributes between JDisc and i-doit. Under **Administration → Import and interfaces → Import → JDISC → JDisc profiles** you can specify how the objects found by JDisc find their way into the IT documentation.
...
The i-doit default installation already provides predefined profiles. Among these predefined profiles is the **Complete import** profile which has the purpose to import all data in i-doit which have been inventoried by JDisc. Keep in mind that you would need to alter these profiles to fit your installation and available types of objects from JDisc.
